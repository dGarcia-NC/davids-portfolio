        ...
        <div className="row fuct-items">
          ...
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">4 Golden Retrievers</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">4 Certifications</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">{`Tea > Coffee`}</div>
            </div>
          </div>
          {/* fuct item */}
          <div className="col col-d-3 col-t-3 col-m-6 border-line-v">
            <div className="fuct-item">
              ...
              <div className="name">Volunteer for fun</div>
            </div>
          </div>
          <div className="clear" />
        </div>
      ...
      <div className="row">
        <div className="col col-d-12 col-t-12 col-m-12 border-line-v">
          <div className="revs-item">
            ...
            <div className="user">
              <div className="img">
                <img src="images/profile.png" alt="David Garcia" />
              </div>
              <div className="info">
